...
# Accept both pbkdf2_sha256 (default) and legacy bcrypt hashes for verification.
# New hashes will be generated with pbkdf2_sha256, but existing users with bcrypt
# hashes can still log in successfully.
