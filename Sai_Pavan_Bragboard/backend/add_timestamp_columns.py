...
def add_missing_timestamp_columns():
    ...
    try:
        ...
        # Update existing users with current timestamp if they don't have values
        ...
        if 'created_at' in [col[0] for col in missing_columns]:
            ...
            print(f"🔄 Updated {updated_created} rows with created_at timestamp")
        ...
        if 'updated_at' in [col[0] for col in missing_columns]:
            ...
            print(f"🔄 Updated {updated_updated} rows with updated_at timestamp")
