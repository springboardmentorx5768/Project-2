...
export default function Sidebar() {
  ...
  const handleLogout = () => {
    if (window.confirm("🚪 Are you sure you want to log out?")) {
      ...
      localStorage.removeItem("refresh_token"); // ✅ clear both
    ...
    <div className="w-64 bg-gray-800 min-h-screen p-6 border-r border-gray-700 flex flex-col justify-between">
      <div>
        ...
        <nav className="space-y-2">
          ...
          <Link to="/postshoutout" className={linkClass("/postshoutout")}>💬 Post Shoutout</Link>
          <Link to="/shoutouts" className={linkClass("/shoutouts")}>📢 Shoutout Feed</Link>
