...
# Add this alongside your User and Shoutout models
class Reaction(Base):
    ...
    # This is the most important part for user-specific tracking
    # It ensures one user can only have ONE reaction per post
